...
def exec(database):
    ...
    try:
        ...
        curso_prerequisitos = parse_requisitos(
            input()) or curso.codigo_requisitos
        ...
        print('Ingresa el semestre, actual: (' +
              str(curso.semestre) + ') ', end='')
        curso_semestre = int(input() or curso.semestre)
        new_curso.semestre = curso_semestre

        print('Ingrese los creditos, actual: (' +
              str(curso.creditos) + ') ', end='')
